...
- minor #3345 StdinFileInfo - fix \_\_toString (keradus)
...
- feature #2944 FunctionToConstantFixer - handle get_class() -> **CLASS** as well (SpacePossum)
...
- bug #945 Skip files containing \_\_halt_compiler() on PHP 5.3 (stof)
...
- bug #754 LowercaseKeywordsFixer - \_\_HALT_COMPILER must not be lowercased (keradus)
